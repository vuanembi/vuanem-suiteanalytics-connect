...
class TRANSACTIONS(NetSuiteIncrementalJob):
    p_key= ["TRANSACTION_ID"],
    incremental_key =  "DATE_LAST_MODIFIED"
    partition_key =  ["TRANDATE"]
    ...
    schema = [
        ...
        {"name": "DELIVERY_TERMS_ID", "type": "STRING"},
        ...
        {"name": "MAGENTO_SO_ID", "type": "INTEGER"},
        {"name": "MAGENTO_TOTAL", "type": "STRING"},
        ...
        {"name": "SUPPORT_PERSON_ID", "type": "INTEGER"},
